...
class AdminHotelController extends Controller
{
    ...
    {
        $hotel = HotelHomeSection::get();
        $amenitie = HotelHomeSection::where('hotelier_id',Auth::guard('hotelier')->user()->id)->get();
        return view('admin.hotel_view', compact('hotel','amenitie'));
    }
    ...
    public function add()
    {
        ...
        return view('admin.hotel_add',compact('amenitie','roomtypes'));
    }
    ...
    {
        $hotel_data = HotelHomeSection::where('id',$id)->first();
        $image = HotelGallery::where("hotel_home_section_id",$hotel_data->id)->get();
        $aminitie = HotelAmenities::get();
        $roomtypes = RoomTypes::get();
        return view('admin.hotel_edit', compact('hotel_data','image','aminitie','roomtypes'));
    }
