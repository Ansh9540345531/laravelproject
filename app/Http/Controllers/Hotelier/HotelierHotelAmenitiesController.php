...
class HotelierHotelAmenitiesController extends Controller
{
    public function index(){
        $user = HotelAmenities::where('hotelier_id',Auth::guard('hotelier')->user()->id)->get();
       // dd($user);
        return view('hotelier.hotel_amenities_view', compact('user'));
    }

    public function add()
    {
        return view('hotelier.hotel_amenities_add');
    }
    ...
    { 
        $request->validate([
            ...
            'amenitie_catagories' => 'required',
            'hotel_amenity_icons' => 'required'
        ]);
        ...
        $obj->hotel_amenity_icons = $request->hotel_amenity_icons;
        $obj->save();
    ...
    public function edit($id){
        ...
        return view('hotelier.hotel_amenities_edit',compact('amenitie_data'));
    }
