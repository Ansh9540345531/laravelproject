...
<body onload="login()">
    ...
    <!-- body start  -->
    <!-- banner start -->
    <div class="container-fluid bg-termusebanner p-0 mb-5" style="background-image:url({{asset('/dis/img/events/terms-of-use-banner.png')}}); background-repeat:no-repeat center center; background-size: cover;">
    ...
    <!-- body content start -->
    <div class="container">
      <h1 class="heading_term">TERMS OF USE</h1>
      <h4 class="term_update my-3">Last updated January 2023</h4>
      <h4 class="my-3">AGREEMENT TO TERMS</h4>
      <p>
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (&ldquo;you&rdquo;)
        and&nbsp;PAGE 1 TRAVELS&nbsp;(&ldquo;we,&rdquo; &ldquo;us&rdquo; or
        &ldquo;our&rdquo;), concerning your access to and use of the<a
          href="https://page1travels.com/"
          >&nbsp;https://page1travels.com/</a
      ...
      <h4 class="text-uppercase mt-5">Terms and Conditions</h4>
      <p>
      ...
      <h4 class="mt-5">INTELLECTUAL PROPERTY RIGHTS</h4>
      <p>
        ...
        &ldquo;Content&rdquo;) and the trademarks, service marks, and logos
        contained therein (the &ldquo;Marks&rdquo;) are owned or controlled by
        ...
        laws of the Indian jurisdiction, foreign jurisdictions, and
        international conventions.
      </p>
      <p>
        The Content and the Marks are provided on the Site &ldquo;AS IS&rdquo;
      ...
      <li>
        ...
        purpose of sending unsolicited emails, or creating user accounts by
      ...
      <li>
        the trick, defraud, or mislead us and other users, especially in any
      ...
      <li>
        ...
        with any party&rsquo;s uninterrupted use and enjoyment of the Site or
      ...
      <li>
        ...
        formats (&ldquo;gifs&rdquo;), 1&times;1 pixels, web bugs, cookies, or
        other similar devices (sometimes referred to as &ldquo;spyware&rdquo; or
        &ldquo;passive collection mechanisms&rdquo; or &ldquo;pcms&rdquo;).
      </li>
      <li>
        except as may be the result of the standard search engine or Internet
      ...
      <h4>USER-GENERATED CONTRIBUTIONS</h4>
        ...
        <li>
          your Contributions do not violate any federal or state law concerning
      ...
      <h4 class="my-3">CONTRIBUTION LICENSE</h4>
      <p>
        ...
        Contributions, and grant and authorize sub-licenses of the foregoing.
        The use and distribution may occur in any media format and through any
        media channels.
      </p>
      <p>
      ...
      <p>
        (1) you should have first-hand experience with the person/entity being
        reviewed.
      </p>
      <p>
