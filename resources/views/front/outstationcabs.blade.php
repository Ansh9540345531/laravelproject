...
<body onload="login()">
    ...
    <div class="container">
      <div class="main-wrapperdiv spaceup_down">
        <div class="">
          <div>
            <h1 class="mb-3 cabs_headingfont">Lorem, ipsum dolor.</h1>
            <p class="cabs_parafont">
              <span id="more">
                erisque enim ligula venenatis dolor. Maecenas nisl est, ultrices
                nec congue eget, auctor vitae massa. Fusce luctus vestibulum sed
                ullamcorper ipsum dignissim ac. In at libero sed nunc venenatis
                imperdiet sed ornare turpis. fringilla congue eros non
                fermentum. Sed dapibus pulvinar nibh tempor porta. venenatis
                dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae
                massa. Fusce luctus vestibulum sed ullamcorper ipsum dignissim
                imperdiet sed ornare turpis. fringilla congue eros non
                fermentum. Sed dapibus pulvinar nibh tempor porta. venenatis
                dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae
                massa. Fusce luctus vestibulum sed ullamcorper ipsum dignissim
                ...
                <div class="">
                  <div>
                    <div class="" id="singel" style="display: block;">
                      <div>
                        <form action="{{route('outstationcabsubmit')}}" method="POST" class="p-4" style="display: grid;">
                        @csrf
                          ...
                          <div class="input_modallogin mb-3">
                            ...
                            <input type="number" name="person" min="1" max="20" placeholder="Number of Person" class="input_login"
                            required />
                          </div>
                          <div class="input_modallogin mb-3">
                            <i class="fas fa-1x fas fa-calendar m-3"></i>
                            <input  type="text" name="pickup_date" placeholder="Pick up date" class="input_login"
                              onfocus="(this.type='date')" onblur="if(!this.value)this.type='text'" required
                            />
                          </div>
                          <div class="input_modallogin mb-3">
                            <i class="fas fa-1x fas fa-clock m-3"></i>
                            <input type="text" name="time" placeholder="Pick up Time" class="input_login"
                  ...
                  <div>
                    <div>
                      <div id="round-trip" style="display: none;">
                        <div>
                          <form action="{{route('outstationcabformsubmit')}}" method="POST" class="p-4" style="display: grid;">
                          @csrf
                          @if(Session::has('message'))
                          <p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('message') }}</p>
                          @endif
                            ...
                            <div class="input_modallogin mb-3">
                              <i class="fas fa-1x fas fa-user m-3"></i>
                              <input  type="number" name="person" min="1" max="50" placeholder="Number of Person" class="input_login" required
                              />
                            </div>
                            <div class="input_modallogin mb-3">
                              <i class="fas fa-1x fas fa-calendar m-3"></i>
                            ...
                            <div class="input_modallogin mb-3">
                              <i class="fas fa-1x fas fa-calendar m-3"></i>
                              <input type="text"  name="return_date" placeholder="Return date" class="input_login"
                                onfocus="(this.type='date')"  onblur="if(!this.value)this.type='text'" required
                              />
                            </div>
                            <div class="input_modallogin mb-3">
      ...
      <div class="row border my-5 p-5" style="background-color: #f2940c;">
        <div class="col-sm-3 cab_rightborder">
          <div class="text-center mt-5 mb-3 pb-3">
            ...
            <h2 class="heading_cabsstyle">Skilled drivers</h2>
          </div>
        </div>
        <div class="col-sm-3 cab_rightborder">
          <div class="text-center mt-5 mb-3 pb-3">
            <h1 class="text-white">135+</h1>
            <h2 class="heading_cabsstyle">Cabs online</h2>
          </div>
        </div>
        <div class="col-sm-3 cab_rightborder">
          <div class="text-center mt-5 mb-3 pb-3">
            <h1 class="text-white">14+</h1>
            <h2 class="heading_cabsstyle">Years on roads</h2>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="text-center mt-5 mb-3 pb-3">
            <h1 class="text-white">29+</h1>
            <h2 class="heading_cabsstyle">Locations</h2>
          </div>
        </div>
      </div>
    </div>
