...
<div class="section-body">
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('hotelhomesection_update',$hotelhomesection_data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div>
                                        <img src="{{ asset('uploads/'.$hotelhomesection_data->photo) }}" alt="" class="w_200">
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label"> Hotel Name *</label>
                                    <input type="text" class="form-control" name="hotel_name" value="{{ $hotelhomesection_data->hotel_name }}">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label"> Description *</label>
                                    <textarea name="description" class="form-control snote h_100" cols="30" rows="10">{{ $hotelhomesection_data->description }}</textarea>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="hotel_location" value="{{ $hotelhomesection_data->hotel_location }}">
                                </div>
                                <div class="mb-4">
                                ...
                                <?php 
                                    $selected = explode(",", $hotelhomesection_data->hotel_amenities);
                                    //dd($selected);
                                ?>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="button_text" value="{{ $hotelhomesection_data->button_text }}">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Existing Image Type</label>
                                    @foreach($image_type as $image_type)
                                    <div>
                                        <img src="{{ asset('image_types/'.$image_type->image_type) }}" alt="" class="w_200 mt-1">
                                    </div>
                                    @endforeach
                                </div>

                                <div class="mb-4">
                                    <label class="form-label"> Change Room Image Type *</label>
                                    <input type="file" class="form-control" name="image_types[]" value="{{ old('image_types') }}" multiple>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Button Link *</label>
                                    <input type="text" class="form-control" name="button_url" value="{{ $hotelhomesection_data->button_url }}">
                                </div>
                                <div class="mb-4">
