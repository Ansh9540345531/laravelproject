...
<a href="{{ route('adminroomtypes_view') }}" class="btn btn-primary"><i class="fa fa-eye"></i> View All</a>
@endsection
...
<div class="section-body">
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('adminroomtypes_update',$roomtypes_data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            <div class="mb-4">
