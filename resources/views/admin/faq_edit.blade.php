                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="answer" class="form-control " name="answer" value="{{ $faq_data->answer }}">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Question Number *</label>
                                    <input type="text" class="form-control" name="question_number" value="{{ $faq_data->question_number }}">
                                </div>
                                <div class="mb-4">
